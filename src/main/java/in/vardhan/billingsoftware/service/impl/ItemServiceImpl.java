...
import in.vardhan.billingsoftware.repository.CategoryRepository;
import in.vardhan.billingsoftware.repository.ItemRepository;
import in.vardhan.billingsoftware.service.FileUploadService;
    ...
    public void deleteItem(String itemId) {
        ...
        if (isFileDeleted) {
            ...
            throw new ResponseStatusException(
                    HttpStatus.INTERNAL_SERVER_ERROR, "Unable to delete the image");
        }
    }
}
